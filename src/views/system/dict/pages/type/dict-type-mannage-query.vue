...
import { dictKey, type dictTypeQueryParam, type dictUse } from '@/types/system/dict'

defineOptions({ name: 'DictTypeManageQuery' })
...
const queryParams = defineModel<dictTypeQueryParam>('queryParams', { required: true })
