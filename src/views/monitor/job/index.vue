        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="是否并发：">
              <div v-if="form.concurrent == 1">
                允许
              </div>
              <div v-else-if="form.concurrent == 0">
                禁止
              </div>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="执行策略：">
              <div v-if="form.misfire_policy == 0">
                默认策略
              </div>
              <div v-else-if="form.misfire_policy == 1">
                立即执行
              </div>
              <div v-else-if="form.misfire_policy == 2">
                执行一次
              </div>
              <div v-else-if="form.misfire_policy == 3">
                放弃执行
              </div>
            </el-form-item>
          </el-col>
